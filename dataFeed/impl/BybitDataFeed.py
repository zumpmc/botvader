...
class BybitDataFeed(DataFeed):
    """Streams BTCUSDT trades from Bybit and publishes batched ticks to S3
    ...
    def _flush(self, window_end: Optional[float] = None) -> None:
        ...
        key = f"bybit/{self.name}/{window_start:.6f}-{window_end:.6f}"
    ...
    def _on_message(self, ws, message: str) -> None:
        ...
        # Bybit trade messages have topic "publicTrade.BTCUSDT"
        topic = raw.get("topic", "")
